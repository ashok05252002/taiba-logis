    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Confirm Action">
      <div className="text-center">
        ...
        <p className="text-taiba-gray my-4">
          Do you really want to <span className="font-bold">{actionText}</span> the cluster <span className="font-bold">{zone.name}</span>?
        </p>
        {actionText === 'deactivate' && <p className="text-sm text-orange-600">This will temporarily disable all operations in this cluster.</p>}
