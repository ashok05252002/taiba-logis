...
const initialTickets = [
    ...
    { id: 'TKT003', orderId: 'N/A', issue: 'Driver shortage in Cluster C during peak hours.', raisedBy: 'System Alert', assignedTo: 'Fatima Hassan', status: 'Resolved', timestamp: '2025-07-31T16:00:00Z', resolution: 'Manually assigned two drivers from Cluster B to cover the shortage.', history: [{ user: 'System', action: 'Created Ticket', timestamp: '2025-07-31T16:00:00Z' }, { user: 'Delivery Admin', action: 'Resolved Ticket', timestamp: '2025-07-31T16:45:00Z' }] },
];
