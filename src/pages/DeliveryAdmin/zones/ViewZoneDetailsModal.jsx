...
import { MapPin, User, Users, Puzzle, CheckCircle, XCircle, Calendar, UserCog } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-taiba-gray">Incharge: {zone.incharge}</span>
          </div>
          <div className="flex items-center space-x-3">
           ...
           <div className="flex items-center space-x-3">
            ...
            <span className="text-taiba-gray">Assigned By: {zone.assigned_by || 'N/A'}</span>
          </div>
          <div className="flex items-center space-x-3">
            <Calendar className="w-5 h-5 text-taiba-purple" />
            <span className="text-taiba-gray">Assigned At: {formattedDate(zone.assigned_at)}</span>
          </div>
